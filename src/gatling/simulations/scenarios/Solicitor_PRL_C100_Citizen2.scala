...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_450_RespondentName") {
          ...
          exec(http("PRL_CitizenC100_450_005_RespondentName")
            ...
            .formParam("c100TempFirstName", "${PRLRandomString}" + "Name")
            .formParam("_ctx", "resp")
            .formParam("onlycontinue", "true")
            .check(
...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_460_RespondentNameRedirect") {
          ...
          exec(http("PRL_CitizenC100_460_005_RespondentNameRedirect")
            ...
            .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
            .header("content-type", "application/x-www-form-urlencoded")
            .check(substring("Provide details for Respondent Name")))
        }
        .pause(MinThinkTime, MaxThinkTime)
...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_660_ContactBetweenChildren") {
          ...
          exec(http("PRL_CitizenC100_660_005_ContactBetweenChildren")
            ...
            .formParam("c1A_supervisionAgreementDetails", "Yes")
            .formParam("saveAndContinue", "true")
...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_710_TakePartInHearings") {
          ...
          exec(http("PRL_CitizenC100_710_005_TakePartInHearings")
            ...
            .formParam("onlycontinue", "true")
            .check(substring("Do you have any language requirements?")))
        }
        .pause(MinThinkTime, MaxThinkTime)
...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_790_CheckYourAnswersFinal") {
          ...
          exec(http("PRL_CitizenC100_790_005_CheckYourAnswersFinal")
            .get(prlURL + "/card_details/${chargeId}")
            .headers(Headers.navigationHeader)
            .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
            .header("content-type", "application/x-www-form-urlencoded")
            .formParam("_csrf", "${csrf}")
...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_780_EnterCardDetails") {

          exec(http("PRL_CitizenC100_780_005_EnterCardDetails")
            .post(prlURL + "/card_details/${chargeId}")
            .headers(Headers.commonHeader)
            .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
            .header("content-type", "application/x-www-form-urlencoded")
...
======================================================================================*/
        ...
        .group("PRL_CitizenC100_790_FinalSubmit") {

          exec(http("PRL_CitizenC100_790_005_FinalSubmit")
