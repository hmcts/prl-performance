...
/*======================================================================================
* Citizen C100 Link & Access Case, view Dashboard 
======================================================================================*/

object Citizen_PRL_C100_ApplicantDashboard {
...
========================================================================================*/
  val RetrieveCase =
    ...
    exec(http("PRL_C100ApplicantDashboard_030_EnterPinPage")
	...
	.group("PRL_C100ApplicantDashboard_040_EnterPinAndCase") {
		exec(http("PRL_C100ApplicantDashboard_040_005_EnterPinAndCase")
	...
	.group("PRL_C100ApplicantDashboard_050_CaseActivatedContinue") {
		exec(http("PRL_C100ApplicantDashboard_050_005_CaseActivatedContinue")
		.post(prlURL + "/pin-activation/case-activated")
		.headers(Headers.navigationHeader)
		.header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
		.formParam("_csrf", "#{csrf}")
  ...
  val GetCase =
	...
	group("PRL_C100ApplicantDashboard_050_OpenCase") {
    	exec(http("PRL_C100ApplicantDashboard_050_005_OpenCase")
  ...
  val KeepDetailsPrivate =
	...
	group("PRL_C100ApplicantDashboard_060_OpenKeepDetailsPrivate") {
    	exec(http("PRL_C100ApplicantDashboard_060_005_OpenKeepDetailsPrivate")
	...
	.group("PRL_C100ApplicantDashboard_070_SelectDetailsKnown") {
		exec(http("PRL_C100ApplicantDashboard_070_005_SelectDetailsKnown")
	...
	.group("PRL_C100ApplicantDashboard_080_SelectKnownDetails") {
		exec(http("PRL_C100ApplicantDashboard_080_005_SelectKnownDetails")
	...
	.group("PRL_C100ApplicantDashboard_090_ConfirmDetails") {
		exec(http("PRL_C100ApplicantDashboard_090_005_ConfirmDetails")
  ...
  val ContactPreferences =
    ...
    exec(http("PRL_C100ApplicantDashboard_100_OpenContactPreferences")
	...
	.group("PRL_C100ApplicantDashboard_110_ChooseContactPreference") {
		exec(http("PRL_C100ApplicantDashboard_110_005_ChooseContactPreference")
	...
	.group("PRL_C100ApplicantDashboard_120_ChooseContactPreferenceReview") {
		exec(http("PRL_C100ApplicantDashboard_120_005_ChooseContactPreferenceReview")
	...
	.group("PRL_C100ApplicantDashboard_130_ConfirmContactPreference") {
		exec(http("PRL_C100ApplicantDashboard_130_005_ConfirmContactPreference")
  ...
  val ConfirmEditContactDetails =
	...
	group("PRL_C100ApplicantDashboard_131_OpenContactPreferences") {
    	exec(http("PRL_C100ApplicantDashboard_131_005_OpenContactPreferences")
	...
	* Select Edit for living in refuge details
    ...
    .exec(http("PRL_C100ApplicantDashboard_132_005_EditStayingInRefuge")
	...
	* Staying in Refuge --> No --> Continue
	...
	.group("PRL_C100ApplicantDashboard_133_StayingInRefugeNo") {
    	exec(http("PRL_C100ApplicantDashboard_133_005_StayingInRefugeNo")
	...
	* Your address --> Continue
    ...
    .exec(http("PRL_C100ApplicantDashboard_134_005_ConfirmAddressContinue")
	...
	* Check your details --> Save & continue
    ...
    .exec(http("PRL_C100ApplicantDashboard_134_005_CheckAnswersSaveContinue")
  ...
  val SupportYouNeed =
    ...
    exec(http("PRL_C100ApplicantDashboard_140_ReasonableAdjustmentsIntro")
	...
	.group("PRL_C100ApplicantDashboard_150_ReasonableAdjustmentsStart") {
		exec(http("PRL_C100ApplicantDashboard_150_005_ReasonableAdjustmentsStart")
	...
	.group("PRL_C100ApplicantDashboard_160_LanguageRequirements") {
		exec(http("PRL_C100ApplicantDashboard_160_005_LanguageRequirements")
	...
	.group("PRL_C100ApplicantDashboard_170_NoDisabilities") {
		exec(http("PRL_C100ApplicantDashboard_170_005_NoDisabilities")
	...
	.group("PRL_C100ApplicantDashboard_180_ReviewSupport") {
		exec(http("PRL_C100ApplicantDashboard_180_005_ReviewSupport")
	...
	.group("PRL_C100ApplicantDashboard_190_ConfirmSupport") {
		exec(http("PRL_C100ApplicantDashboard_190_005_ConfirmSupport")
  ...
  val RespondToApplication =
    ...
    exec(http("PRL_C100ApplicantDashboard_200_TaskListPage")
    ...
    .exec(http("PRL_C100ApplicantDashboard_210_LegalRepresentation")
	...
	.group("PRL_C100ApplicantDashboard_220_NoLegalRepresentation") {
		exec(http("PRL_C100ApplicantDashboard_220_005_NoLegalRepresentation")
	...
	.group("PRL_C100ApplicantDashboard_230_ConfirmNoLegalRepresentation") {
		exec(http("PRL_C100ApplicantDashboard_230_005_ConfirmNoLegalRepresentation")
	...
	.group("PRL_C100ApplicantDashboard_240_DoYouConsentToApplication") {
		exec(http("PRL_C100ApplicantDashboard_240_005_DoYouConsentToApplication")
	...
	.group("PRL_C100ApplicantDashboard_250_CheckYourConsent") {
		exec(http("PRL_C100ApplicantDashboard_250_005_CheckYourConsent")
	...
	.group("PRL_C100ApplicantDashboard_260_ConfirmYourConsent") {
		exec(http("PRL_C100ApplicantDashboard_260_005_ConfirmYourConsent")
	...
	.group("PRL_C100ApplicantDashboard_270_HaveYouAttendedMIAM") {
		exec(http("PRL_C100ApplicantDashboard_270_005_HaveYouAttendedMIAM")
	...
	.group("PRL_C100ApplicantDashboard_280_WillingToAttendMIAM") {
		exec(http("PRL_C100ApplicantDashboard_280_005_WillingToAttendMIAM")
	...
	.group("PRL_C100ApplicantDashboard_290_MIAMCheckYourAnswers") {
		exec(http("PRL_C100ApplicantDashboard_290_005_MIAMCheckYourAnswers")
	...
	.group("PRL_C100ApplicantDashboard_300_MIAMConfirmAnswers") {
		exec(http("PRL_C100ApplicantDashboard_300_005_MIAMConfirmAnswers")
	...
	.group("PRL_C100ApplicantDashboard_310_EverBeenInvolvedInProceedings") {
		exec(http("PRL_C100ApplicantDashboard_310_005_EverBeenInvolvedInProceedings")
	...
	.group("PRL_C100ApplicantDashboard_320_PreviousProceedingsCheckYourAnswers") {
		exec(http("PRL_C100ApplicantDashboard_320_005_PreviousProceedingsCheckYourAnswers")
	...
	.group("PRL_C100ApplicantDashboard_330_PreviousProceedingsConfirmAnswers") {
		exec(http("PRL_C100ApplicantDashboard_330_005_PreviousProceedingsConfirmAnswers")
	...
	.group("PRL_C100ApplicantDashboard_340_SafetyConcerns") {
		exec(http("PRL_C100ApplicantDashboard_340_005_SafetyConcerns")
	...
	.group("PRL_C100ApplicantDashboard_350_AnySafetyConcerns") {
		exec(http("PRL_C100ApplicantDashboard_350_005_AnySafetyConcerns")
	...
	.group("PRL_C100ApplicantDashboard_360_SafetyConcernsConfirmAnswers") {
		exec(http("PRL_C100ApplicantDashboard_360_005_SafetyConcernsConfirmAnswers")
	...
	.exec(http("PRL_C100ApplicantDashboard_370_RespondToAllegations")
	...
	.group("PRL_C100ApplicantDashboard_380_RespondToAllegationsCheckYourAnswers") {
		exec(http("PRL_C100ApplicantDashboard_380_005_RespondToAllegationsCheckYourAnswers")
	...
	.group("PRL_C100ApplicantDashboard_390_RespondToAllegationsConfirmAnswers") {
		exec(http("PRL_C100ApplicantDashboard_390_005_RespondToAllegationsConfirmAnswers")
	...
	.group("PRL_C100ApplicantDashboard_400_StartInternationalFactors") {
		exec(http("PRL_C100ApplicantDashboard_400_005_StartInternationalFactors")
	...
	.group("PRL_C100ApplicantDashboard_410_ChildrensLivesBasedOutsideUK") {
		exec(http("PRL_C100ApplicantDashboard_410_005_ChildrensLivesBasedOutsideUK")
	...
	.group("PRL_C100ApplicantDashboard_420_ChildrensParentsBasedOutsideUK") {
		exec(http("PRL_C100ApplicantDashboard_420_005_ChildrensParentsBasedOutsideUK")
	...
	.group("PRL_C100ApplicantDashboard_430_OtherPersonOutsideUK") {
		exec(http("PRL_C100ApplicantDashboard_430_005_OtherPersonOutsideUK")
	...
	.group("PRL_C100ApplicantDashboard_440_OtherCountryAskedForInfo") {
		exec(http("PRL_C100ApplicantDashboard_440_005_OtherCountryAskedForInfo")
	...
	.group("PRL_C100ApplicantDashboard_450_InternationalFactorsConfirmAnswers") {
		exec(http("PRL_C100ApplicantDashboard_450_005_InternationalFactorsConfirmAnswers")
	...
	.group("PRL_C100ApplicantDashboard_460_ReviewAndSubmit") {
		exec(http("PRL_C100ApplicantDashboard_460_005_ReviewAndSubmit")
	...
	.group("PRL_C100ApplicantDashboard_470_CheckYourAnswers") {
		exec(http("PRL_C100ApplicantDashboard_470_005_CheckYourAnswers")
...
.doIf(session => session("pcqScreens").as[Int] != 1) {
    ...
    * Equality and diversity questions - I don't want to answer these questions
    ...
    group("PRL_C100ApplicantDashboard_471_PCQStartNo") {
      exec(http("PRL_C100ApplicantDashboard_571_005_PCQStartNo")
        .post(pcqURL + "/opt-out")
...
.doIf(session => session("pcqScreens").as[Int] == 1) { // PCQ Steps if flag is set to 1
    ...
    * Equality and diversity questions - Continue to questions
    ...
    group("PRL_C100ApplicantDashboard_471_PCQStartYes") {
      exec(http("PRL_C100ApplicantDashboard_471_005_PCQStartYes")
    ...
    * Equality and diversity questions - What is your Language? - English
    ...
    .group("PRL_C100ApplicantDashboard_472_SelectLanguage") {
      exec(http("PRL_C100ApplicantDashboard_472_005_SelectLanguage")
    ...
    * Equality and diversity questions - What is your Sex? - Prefer not to say
    ...
    .group("PRL_C100ApplicantDashboard_473_SelectSex") {
      exec(http("PRL_C100ApplicantDashboard_473_005_SelectSex")
        .post(pcqURL + "/sex")
        .headers(Headers.commonHeader)
        .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7")
        .header("content-type", "application/x-www-form-urlencoded")
    ...
    * Equality and diversity questions - Which of the following best describes how you think of yourself? - Hetero or straight
    ...
    .group("PRL_C100ApplicantDashboard_474_SelectSexualOrientation") {
      exec(http("PRL_C100ApplicantDashboard_474_005_SelectSexualOrientation")
    ...
    * Equality and diversity questions - Are you married or in a legally registered civil partnership? - Yes
    ...
    .group("PRL_C100ApplicantDashboard_475_SelectMaritialStatus") {
      exec(http("PRL_C100ApplicantDashboard_475_005_SelectMaritialStatus")
    ...
    * Equality and diversity questions - What is your ethnic group? - Prefer not to say
    ...
    .group("PRL_C100ApplicantDashboard_476_SelectEthnicGroup") {
      exec(http("PRL_C100ApplicantDashboard_476_005_SelectEthnicGroup")
    ...
    * Equality and diversity questions - What is your religion? - Prefer not to say
    ...
    .group("PRL_C100ApplicantDashboard_477_SelectReligion") {
      exec(http("PRL_C100ApplicantDashboard_477_005_SelectReligion")
    ...
    * Equality and diversity questions - Do you have any physical or mental health conditions? - No
    ...
    .group("PRL_C100ApplicantDashboard_478_HealthConditions") {
      exec(http("PRL_C100ApplicantDashboard_478_005_HealthConditions")
    ...
    * Equality and diversity questions - Are you pregnant or have you been pregnant in the last year? - No
    ...
    .group("PRL_C100ApplicantDashboard_479_SelectPregnancy") {
      exec(http("PRL_C100ApplicantDashboard_479_005_SelectPregnancy")
    ...
    * Equality and diversity questions - You have answered the equality questions - Continue to next steps
    ...
    .group("PRL_C100ApplicantDashboard_4791_PCQReturnToService") {
      exec(http("PRL_C100ApplicantDashboard_4791_005_PCQReturnToService")
  ...
  val YourApplication =
    ...
    exec(http("PRL_C100ApplicantDashboard_510_YourApplication")
      .get(prlURL + "/applicant/documents/download/type/c100-application/en")
      .headers(Headers.navigationHeader)
      .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7")
      .check(status.is(200)))
  ...
  val CheckHarmViolenceAllegations =
    ...
    exec(http("PRL_C100ApplicantDashboard_520_HarmAndViolenceDoc")
  ...
  val MakeRequestToCourtAboutCase =  // ** NEW FUNCTIONALITY FOR PRL R7.0 (Out of scope for R6.0)
    ...
    exec(http("PRL_C100ApplicantDashboard_530_MakeRequestToCourtAboutCase")
  ...
  val ResponseToApplication = // ** NEW FUNCTIONALITY FOR PRL R6.0
    ...
    exec(http("PRL_C100ApplicantDashboard_510_RespondentDocuments")
	...
	* Select the document link to open doc
    ...
    .exec(http("PRL_C100ApplicantDashboard_510_RespondentDocumentDownload")
	...
	* Return to CaseView
	...
	.group("PRL_C100ApplicantDashboard_510_ReturnToCaseView") {
       exec(http("PRL_C100ApplicantDashboard_510_ReturnToCaseView")
      .get(prlURL + "/case/#{caseId}")
      .headers(Headers.navigationHeader)
      .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
  ...
  val UploadDocumentsApplicationsStatements =
    ...
    exec(http("PRL_C100ApplicantDashboard_540_DocumentsUpload")
	...
	* Select Your Position Statement Link
    ...
    .exec(http("PRL_C100ApplicantDashboard_550_YourPositionStatement")
	...
	* Your Position Statement Link - Has the court asked for this document? --> Yes, Continue
	...
	.group("PRL_C100ApplicantDashboard_560_HasCourtAskedForDocumentYes") {
       exec(http("PRL_C100ApplicantDashboard_560_005_HasCourtAskedForDocumentYes")
	...
	* Before you submit a document --> Continue
	...
	.group("PRL_C100ApplicantDashboard_570_DocumentSharingDetails") {
       exec(http("PRL_C100ApplicantDashboard_570_005_DocumentSharingDetails")
	...
	* Sharing your documents, Is there a good reason... --> No, Continue
	...
	.group("PRL_C100ApplicantDashboard_580_SharingDocumentsNo") {
       exec(http("PRL_C100ApplicantDashboard_558_005_SharingDocumentsNo")
	...
	* Position statement, Write witness statement free text-> Submit
	...
	.group("PRL_C100ApplicantDashboard_590_WitnessStatementSubmit") {
       exec(http("PRL_C100ApplicantDashboard_590_005_WitnessStatementSubmit")
	...
	* Position statement, Select checkbox declaratiom -> Continue
	...
	.group("PRL_C100ApplicantDashboard_600_UploadDocumentContinue") {
       exec(http("PRL_C100ApplicantDashboard_600_005_UploadDocumentContinue")
	...
	* Select upload another document link
	...
	.group("PRL_C100ApplicantDashboard_610_UploadAnotherDocument") {
       exec(http("PRL_C100ApplicantDashboard_610_005_UploadAnotherDocument")
	...
	* Select Emails, screenshots, images and other media files link (media files)
	======================================================================================*/
 	...
 	.exec(http("PRL_C100ApplicantDashboard_620_SelectMediaFilesLink")
	...
	/*======================================================================================
	* Emails, screenshots, images and other media files - Has the court asked for this document? --> Yes, Continue
	======================================================================================*/

	.group("PRL_C100ApplicantDashboard_630_HasCourtAskedForDocumentYes") {
       exec(http("PRL_C100ApplicantDashboard_630_005_HasCourtAskedForDocumentYes")
	...
	* Before you submit a document --> Continue
	...
	.group("PRL_C100ApplicantDashboard_640_DocumentSharingDetails") {
       exec(http("PRL_C100ApplicantDashboard_640_005_DocumentSharingDetails")
	...
	* Sharing your documents, Is there a good reason... --> No, Continue
	...
	.group("PRL_C100ApplicantDashboard_650_SharingDocumentsNo") {
       exec(http("PRL_C100ApplicantDashboard_650_005_SharingDocumentsNo")
	...
	* Emails, screenshots, images and other media files, select choose file button, select file and then upload
	...
	.group("PRL_C100ApplicantDashboard_660_UploadDocument") {
       exec(http("PRL_C100ApplicantDashboard_660_005_UploadDocument")
	...
	* Emails, screenshots, images and other media files, Select checkbox declaration -> Continue
	...
	.group("PRL_C100ApplicantDashboard_670_UploadDocumentContinue") {
       exec(http("PRL_C100ApplicantDashboard_670_005_UploadDocumentContinue")
  ...
  val ViewAllDocuments =
    ...
    exec(http("PRL_C100ApplicantDashboard_690_ViewAllDocuments")
  ...
  val ViewServedAppPack =
    ...
    exec(http("PRL_C100ApplicantDashboard_700_ViewServedApplicationPack")
	...
	//================================================================================================
		.exec(http("PRL_C100ApplicantDashboard_71#{counter}_ApplicationPackDocumentDownload")
  ...
  val ViewRespondentsDocuments =
    ...
    exec(http("PRL_C100ApplicantDashboard_710_ViewRespondentDocs")
	...
	//Open a document from within the pack
	//================================================================================================
		.exec(http("PRL_C100ApplicantDashboard_72#{counter}_RespondentAppPackDocumentDownload")
  ...
  val ViewApplicantsDocuments =
    ...
    exec(http("PRL_C100ApplicantDashboard_720_ViewApplicantsDocs")
      .get(prlURL + "/applicant/documents/view/applicant/doc")
      .headers(Headers.navigationHeader)
      .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
	  .check(regex("""<a href=/applicant/documents/download/(.*?) target=\"_blank\">""").findAll.saveAs("documentsToView"))
	...
	//Open a document from within the pack
	//================================================================================================
		.exec(http("PRL_C100ApplicantDashboard_73#{counter}_ApplicantDocumentDownload")
		  .get(prlURL + "/applicant/documents/download/#{downloadDocument}")
		  .headers(Headers.navigationHeader)
		  .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
		  .check(status.is(200)))
  ...
  val ViewOrdersFromTheCourt =
    ...
    exec(http("PRL_C100ApplicantDashboard_740_ViewOrdersFromTheCourt")
	...
	//Open a document from within the pack
	//================================================================================================
		.exec(http("PRL_C100ApplicantDashboard_75#{counter}_CourtOrderDocumentDownload")
		  .get(prlURL + "/applicant/documents/download/#{downloadDocument}")
		  .headers(Headers.navigationHeader)
		  .header("accept", "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9")
		  .check(status.is(200)))
  ...
  val ViewCourtHearings =
	...
	group("PRL_C100ApplicantDashboard_760_ViewCourtHearings") {
      exec(http("PRL_C100ApplicantDashboard_460_005_ViewCourtHearings")
